...
class PushDialog : Gtk.Dialog
{
	...
	private void input_changed () {
		var full_info_filled = (d_remote_name.get_active_text() != null)
			&& (d_remote_ref_name.get_active_text() != "");
		set_response_sensitive(Gtk.ResponseType.OK, full_info_filled);
		d_upstream.sensitive = full_info_filled && d_local_ref_branch.active && d_remote_ref_branch.active;
	}
