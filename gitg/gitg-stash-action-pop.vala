...
class StashActionPop : GitgExt.UIElement, GitgExt.Action, Object
{
	...
	public StashActionPop(GitgExt.Application        application,
	...
	{
		owned get { return _("Pop stash"); }
	}

	public override string description
	{
		owned get { return _("Pop selected stash"); }
	}
	...
	public void activate()
	{
		var dlg = new Gtk.MessageDialog(application as Gtk.Window,
		                                ...
		                                "%s",
		                                @"Are you sure to pop stash \"$index\"");
		...
		dlg.response.connect((d, resp) => {
			...
			{
				application.repository.pop_stash(index);
